...
@WebServlet(urlPatterns = "/Agrega",
  initParams = {
     @WebInitParam(name = "class", value = "interfaces.InterfazAgrega")
  }
)
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
   ...
   private void encabezadoHTML() throws ServletException, IOException
   {
      ...
      out.println("<!DOCTYPE html> \n" +
         ...
         "Introduzca el id del producto que desea agregar.</p>");
   }

  private void AgregarProducto() throws ServletException, IOException
  {
      encabezadoHTML(); ///Preparar encabezado de la pagina Web
      out.println(
         "<form method=POST action=Agrega> \n" +
